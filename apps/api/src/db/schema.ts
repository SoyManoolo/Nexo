...
export const projects = pgTable('projects', {
  ...
  check('projects_color_hex', sql`${table.color} IS NULL OR ${table.color} ~ '^#[0-9A-Fa-f]{6}$'`),
  check('projects_archived_at_consistent', sql`
